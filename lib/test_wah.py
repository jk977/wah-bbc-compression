...
class TestWAH(ut.TestCase):
    def test_run_length(self):
        for ws in range(8, 65):
            # test for no runs
            self.assertEqual(run_length('', ws), 0)
            self.assertEqual(run_length('0', ws), 0)
            self.assertEqual(run_length('1', ws), 0)
            self.assertEqual(run_length('01', ws), 0)
            self.assertEqual(run_length('10', ws), 0)
            self.assertEqual(run_length('01'*1000, ws), 0)
